...
const commands = {
    ...
    contact: (outputElement) => {
        outputElement.textContent =
            "email\t\t-> techhcrafter@gmail.com\nlinkedin\t-> ";

        const linkedinLink = document.createElement("a");
        linkedinLink.href =
            "https://www.linkedin.com/in/vishnuvarthan-m-037616331/";
    ...
    skills: (outputElement) => {
        ...
        leetcodeLink.textContent = "https://leetcode.com/u/vishnu-varthan-05/";
    ...
    projects: (outputElement) => {
        ...
        githubLink.href = "https://github.com/Vishnu-Varthan-05";
        githubLink.textContent = "https://github.com/Vishnu-Varthan-05";
